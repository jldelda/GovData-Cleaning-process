...
#Indicator
df_IND$Display_Name = gsub("\\d\\d ","", df_IND$Display_Name)
...
# # Indicator in df
df$question = gsub("\\d\\d ","", df$question)
...
Hierarchy$Indicator = gsub("non-governmental","nongovernmental", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("adrs ","", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("adr ","", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("alternative dispute resolution are","alternative dispute resolution mechanisms are", Hierarchy$Indicator)
