...
Hierarchy$Indicator = gsub("patent cooperation treaty \\(pct\\) ", "pct ", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("pisa", "pisa,", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("decisionmaking", "decision-making", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("rule of law \\(sgi\\)", "rule of law", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("fbn", "fb-n", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("association competence business", "association competence (business)", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("association competence others", "association competence (others)", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("legislative actors resources", "legislative actors' resources", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("monitoring agencies bureaucracies", "monitoring agencies, bureaucracies", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("intraparty", "intra-party", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("banks nonperforming", "banks' nonperforming", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("child care density age 35", "child care density, age 3-5", Hierarchy$Indicator)
#Hierarchy$Indicator = gsub("rank among 41 countries", "rank among 41 countries - Quality of Democracy", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("regulatory impact analysis \\(ria\\)", "ria", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("citizens participatory", "citizens' participatory", Hierarchy$Indicator)
