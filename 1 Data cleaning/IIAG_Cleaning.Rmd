...
df_IND$Indicator = df_IND$Display_Name
df_IND$Indicator = gsub("IIAG_calculation", "", df_IND$Indicator)
...
df$Indicator = gsub("IIAG_calculation", "", df$Indicator)
...
Hierarchy$Indicator = gsub("IIAG_calculation", "", Hierarchy$Indicator)
...
Master_IND$Display_Name = trimws(gsub("IIAG_calculation", "", Master_IND$Display_Name), which = 'both')
