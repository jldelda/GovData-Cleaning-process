...
df_IND$Indicator = gsub("people's",'peoples',df_IND$Indicator) 
df_IND$Indicator = gsub("peoples'",'peoples',df_IND$Indicator) 

# Create ID in df
df$Indicator = tolower(df$question)
df$Indicator = gsub("people's",'peoples',df$Indicator)
df$Indicator = gsub("peoples'",'peoples',df$Indicator) 
...
Hierarchy$Temp = trimws(Hierarchy$Value.Type.Slug, which = 'both')
Hierarchy$Temp = gsub(" ", ".",Hierarchy$Temp)
Hierarchy = Hierarchy %>% mutate(Indicator = paste(Indicator, Dataset, Temp, sep = "-"))
