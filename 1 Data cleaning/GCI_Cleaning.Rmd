...
## Make similar df_IND$Indicator to match it with Hierarchy
df_IND$Indicator = df_IND$Indicator_Name
df_IND$Indicator = gsub("/100000 pop.", "", df_IND$Indicator)
df_IND$Indicator = gsub("[,]", "", df_IND$Indicator)
df_IND$Indicator = gsub("[*]", "", df_IND$Indicator)
df_IND$Indicator = gsub("[-]", " ", df_IND$Indicator)
df_IND$Indicator = gsub("[[:punct:]]", " ", df_IND$Indicator)
df_IND$Indicator = gsub("[0-9]", " ", df_IND$Indicator)
df_IND$Indicator = gsub("best", "", df_IND$Indicator)
df_IND$Indicator = gsub("[A-C] ", "", df_IND$Indicator)
df_IND$Indicator = gsub(" pop", "", df_IND$Indicator)
df_IND$Indicator = gsub("ICT", "Information and Comunications technology", df_IND$Indicator)
df_IND$Indicator = trimws(df_IND$Indicator)
...
Hierarchy$Indicator = gsub("[0-9]", " ", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("WEF", " ", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("1-7 Best", "Value", Hierarchy$Indicator)
Hierarchy$Indicator = trimws(Hierarchy$Indicator)

Hierarchy = Hierarchy %>% mutate(Indicator = paste(Indicator, Dataset, Value.Type.Slug, sep = "-"))

Hierarchy$Indicator = gsub("Firmlevel", "Firm level", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("Firm level technology absorption-GCI-1-7 Best", "Firm level technology absorption-GCI-Value", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("Malaria cases-GCI-100000 pop", "Malaria cases-GCI-Value", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("Tuberculosis cases-GCI-100000 pop", "Tuberculosis cases-GCI-Value", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("Availability of research and training services-GCI-1-7 Best", "FAvailability of research and training services-GCI-Value", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("FAvailability", "Availability", Hierarchy$Indicator)
Hierarchy$Indicator = trimws(Hierarchy$Indicator)
