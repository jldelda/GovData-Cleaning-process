...
df_IND$Indicator = gsub("hivaids", "hiv-aids", df_IND$Indicator)
df_IND$Indicator = gsub("gdp per capita growth", "", df_IND$Indicator)
df_IND$Indicator = gsub("scale 0  100", "", df_IND$Indicator)
df_IND$Indicator = gsub("oneyearold", "one-year-old", df_IND$Indicator)
df_IND$Indicator = gsub("underfive", "under five", df_IND$Indicator)
df_IND$Indicator = gsub("1549", "15-49", df_IND$Indicator)
df_IND$Indicator = gsub("enrolment", "enrollment", df_IND$Indicator)
...
df$Indicator = gsub("hivaids", "hiv-aids", df$Indicator)
df$Indicator = gsub("gdp per capita growth", "", df$Indicator)
df$Indicator = gsub("scale 0  100", "", df$Indicator)
df$Indicator = gsub("oneyearold", "one-year-old", df$Indicator)
df$Indicator = gsub("underfive", "under five", df$Indicator)
df$Indicator = gsub("1549", "15-49", df$Indicator)
df$Indicator = gsub("enrolment", "enrollment", df$Indicator)
