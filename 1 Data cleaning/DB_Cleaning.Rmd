...
# Drop unused columns
dropIND = c("Rank", "Category_11",  "Category_12",  "Category_13", "Category_14", "Category_15",  "Category_21",  "Category_22", "Category_23", "Category_24" ,"Category_25", "Category_31", "Category_32", "Category_33", "Category_34",  "New1", "New2", "New3","New4", "New5", "keyN", "Value_Type_Slug", "Units", "Rank_1", "Rank_2", "Rank_3")
...
```{r}
# Create Indicator_Id 
# Get rid of the methodologies
df_IND$Display_Name = gsub("[[:digit:]]", "", df_IND$Display_Name)
df_IND$Display_Name = gsub("DB methodology", "", df_IND$Display_Name)
df_IND$Display_Name = gsub("DB", "", df_IND$Display_Name)
df_IND$Display_Name = gsub("index", "", df_IND$Display_Name)
df_IND$Display_Name = gsub("Rank", "", df_IND$Display_Name)
df_IND$Display_Name = gsub("  ", " ", df_IND$Display_Name)
df_IND$Display_Name = trimws(df_IND$Display_Name, which = 'both')
df_IND$Indicator_Name = df_IND$Display_Name
...
# Indicator in df_IND
df_IND$Indicator = df_IND$Indicator_Name
df_IND = df_IND %>% mutate(Indicator = paste(tolower(Indicator), Dataset, answer, sep = "-"))

# Indicator in df
df$question = gsub("[[:digit:]]", "", df$question)
df$question = gsub("DB methodology", "", df$question)
df$question = gsub("DB", "", df$question)
df$question = gsub("index", "", df$question)
df$question = gsub("Rank", "", df$question)
df$question = gsub("  ", " ", df$question)
df$question = trimws(df$question, which = 'both')
df$Indicator = df$question

df = df %>% mutate(Indicator = paste(tolower(Indicator), dataset, answer, sep = "-"))
...
#Hierarchy$Indicator = gsub("time", "", Hierarchy$Indicator)
#Hierarchy$Indicator = gsub("days", "", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("  ", " ", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("\\:", "", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("\\(", "", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("\\)", "", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("[[:digit:]]", "", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("DB methodology", "", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("DB", "", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("  ", " ", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("starting a business men", "starting a business time men days", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("starting a business \\(women\\)", "starting a business time women days", Hierarchy$Indicator)
#Hierarchy$Indicator = gsub("\\(men\\)", "men", Hierarchy$Indicator)
#Hierarchy$Indicator = gsub("\\(women\\)", "women", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("index", "", Hierarchy$Indicator)
#Hierarchy$Indicator = gsub("index", "", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("old methodology", "", Hierarchy$Indicator)
Hierarchy$Indicator = gsub("dtfpostfiling", "postfiling", Hierarchy$Indicator)

Hierarchy$Indicator = trimws(Hierarchy$Indicator, which = 'both')

#Hierarchy$Indicator = gsub("alternative dispute resolution is","alternative dispute resolution mechanisms are", Hierarchy$Indicator)
...
# MERGE
Master_IND = merge(df_IND, Hierarchy, by = 'Indicator', all.x = T)
